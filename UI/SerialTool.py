...
class SerialToolUI(object):
    ...
    def create_frm_left_serial_set(self):
        ...
        串口配置，比如波特率，奇偶校验等
        '''
        setting_label_list = ["BaudRate :", "Parity :", "DataBit :", "StopBit :", "cameraId :"]
        ...
        self.frm_left_combobox_cameraId = ttk.Combobox(self.frm_left_serial_set,
                                                       width=12,
                                                       values=cameraId_list)
        ...
        self.frm_left_combobox_cameraId.grid(row=4, column=1, padx=2, pady=2, sticky="e")
        ...
        self.frm_left_combobox_cameraId.current(0)
    ...
    def create_frm_right_reset(self):
        ...
        self.frm_right_reset_label = pytk.PyLabel(self.frm_right_reset,
                                                  ...
                                                  font=font)
        self.test_mode_cbtn_var = tk.IntVar()
        self.new_line_cbtn_var = tk.IntVar()
        self.send_hex_cbtn_var = tk.IntVar()
        self.frm_right_reset_testMode_checkbtn = pytk.PyCheckbutton(self.frm_right_reset,
                                                                   text="Test Mode",
                                                                   variable=self.test_mode_cbtn_var,
                                                                   font=font)
        ...
        self.frm_right_reset_testMode_checkbtn.grid(row=0, column=1, sticky="wesn")
        self.frm_right_reset_newLine_checkbtn.grid(row=0, column=2, sticky="wesn")
        self.frm_right_reset_hex_checkbtn.grid(row=0, column=3, sticky="wesn")
        self.frm_right_reset_btn.grid(row=0, column=4, padx=5, pady=5, sticky="wesn")
        self.frm_right_send_btn.grid(row=0, column=5, padx=5, pady=5, sticky="wesn")
        self.send_hex_cbtn_var.set(1)
    ...
    def create_frm_right_clear(self):
        ...
        self.receive_hex_cbtn_var.set(1)
